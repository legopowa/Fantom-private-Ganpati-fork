...
class LamportTest:
    ...
    def can_test_key_functions(self, accs):
        ...
        paddressToBroadcast = '0xF821Be363D00347d6D3f45944584C2f5c6eF65dD'
        ...
        _contract.grantActivityContractPermission(
        ...
        ContractPermissionGranted_filter = _contract.events.ContractPermissionGranted.createFilter(fromBlock='latest')

        for event in ContractPermissionGranted_filter.get_all_entries():
            data = event['args']['contractAddress']
            print(f"Contract added: {data}")
