...
class LamportTest:
    ...
    def can_test_key_functions(self, accs):
        ...
        commission = 20
        bcommission = commission.to_bytes(4, 'big')
        pcommission = solidity_pack_value_bytes(bcommission)
        packed_message = pcommission.hex() + nextpkh[2:]
        ...
        _contract.setCoinCommissionStepOne(
            current_keys.pub,
            sig,
            nextpkh,
            commission,
        ...
        _contract.setCoinCommissionStepTwo(
            current_keys.pub,
            sig,
            nextpkh,
            commission,
